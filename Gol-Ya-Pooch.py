username = input("shomare daneshjooE khod ra vared konid:")
while username != ("1401231011"):
    print("shomare daneshjooE ghalat ast")
    username = input("shomare daneshjooE khod ra vared konid:")
print("shomare daneshjooE sahih ast")
password = input("lotfan Code melli khod ra varedkonid:")
while password != ("0151288453"):
